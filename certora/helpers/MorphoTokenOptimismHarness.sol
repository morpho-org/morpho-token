...
import {DelegationTokenHarness} from "certora/helpers/DelegationTokenHarness.sol";

/// @title MorphoTokenOptimism
/// @author Morpho Association
/// @custom:contact security@morpho.org
/// @notice Harness for the Morpho token contract for Optimism networks.
contract MorphoTokenOptimismHarness is DelegationTokenHarness, IOptimismMintableERC20 {
    /* CONSTANTS */
